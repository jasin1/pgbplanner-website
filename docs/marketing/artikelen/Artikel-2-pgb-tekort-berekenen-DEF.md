---
titel: "Je pgb raakt eerder op dan verwacht: zo bereken je hoeveel je tekortkomt"
title_tag: "PGB-tekort berekenen: hoeveel kom je precies tekort"
slug: pgb-tekort-berekenen
meta_description: "Je pgb-budget lijkt bijna op terwijl er nog een flink deel van het jaar voor je ligt. Zo bereken je of dat gevoel klopt en hoeveel je naar verwachting tekortkomt."
primair_keyword: "pgb budget bijna op"
secundair_keyword: "pgb tekort berekenen"
controle_op: 2027-01-01
versie: v4-definitief
---

# Je pgb raakt eerder op dan verwacht: zo bereken je hoeveel je tekortkomt
...
```
wat je tot nu toe uitgaf  ÷  maanden die voorbij zijn  =  gemiddelde maandkosten
gemiddelde maandkosten  ×  maanden die nog komen      =  geschatte kosten tot het eind
wat er nog over is  −  geschatte kosten tot het eind  =  verwachte ruimte of tekort
```
...
```
een gewone maand tot nu toe  +/−  wat er vanaf nu verandert  =  je maandkosten vanaf nu

wat er nog over is
  min  je maandkosten vanaf nu  ×  maanden die nog komen
  min  eenmalige kosten die je nog verwacht
= de ruimte of het tekort dat je verwacht
```
...
Nog één ding om in de gaten te houden. Heb je een zorgverlener met een arbeidsovereenkomst, dan betaal je werkgeverslasten die bovenop het afgesproken brutoloon komen en ook uit je budget worden betaald. Reken je alleen met het brutoloon, dan reken je te laag. In de bestedingen op je budgetoverzicht zitten die kosten al. [INTERNE LINK: artikel 1 over werkgeverslasten]
...
```
3.700  +  250  =  3.950 euro per maand vanaf nu

3.950  ×  5 maanden  =  19.750
19.750  +  1.500 eenmalig  =  21.250 euro nodig

20.000 beschikbaar  −  21.250 nodig  =  ongeveer 1.250 euro tekort
```
...
<!-- PRODUCTBLOK, mid-article CTA. Positie is bewust hier: de lezer heeft net gezien hoeveel stappen de berekening kost en dat hij hem opnieuw moet doen bij elke wijziging. -->

> **De omweg via je gemiddelde is niet nodig**
>
> PGB Planner rekent vooruit met je eigen zorgverleners, uren en tarieven. Geen gewone maand terugrekenen uit je overzicht, geen uitschieters eruit vissen. En je kunt een tariefverhoging of extra uren doorrekenen zonder dat er iets aan je echte gegevens verandert.
>
> **Probeer PGB Planner 21 dagen gratis →**
...
Wil je dit niet elke keer met de hand doen, dan kun je [PGB Planner 21 dagen gratis proberen](/proberen).

---

## Bronnen

- Sociale Verzekeringsbank, [Belangrijke informatie per zorgovereenkomst](https://www.svb.nl/nl/pgb/zorgovereenkomsten/belangrijke-informatie-per-zorgovereenkomst) (werkgeverslasten en doorbetaling tijdens vakantie)
- Sociale Verzekeringsbank, [Minimumloon en vakantiegeld](https://www.svb.nl/nl/pgb/declareren-en-betalen/minimumloon-en-vakantiegeld)
- Sociale Verzekeringsbank, [Uitleg over het budgetoverzicht](https://www.svb.nl/nl/pgb/pgb-in-het-kort/uitleg-over-het-budgetoverzicht)
